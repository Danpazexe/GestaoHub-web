-- ============================================================================
-- GestãoHub — APLICAR TUDO (migrações consolidadas 0001 → 0004)
-- ============================================================================
-- Arquivo único, idempotente e na ORDEM CORRETA de dependência. Pode ser rodado
-- mesmo se parte já foi aplicada (tudo usa IF NOT EXISTS / CREATE OR REPLACE /
-- DROP POLICY IF EXISTS). Cole inteiro no Supabase Dashboard > SQL Editor.
--
-- Ordem (importa): localização (0001) → aprovação (0002) → imagens/validade
-- (0003, recria a view com image_path) → views em português (0004, que leem a
-- view já com image_path).
--
-- Pós-aplicação: Settings > API > "Exposed schemas" → adicionar `admin` para
-- consumir as views admin.visao_* pelo PostgREST.
--
-- Observação: 0003 faz CREATE OR REPLACE da admin_validade_products_view
-- apendando image_path; se a sua view em produção tiver outra ORDEM de colunas,
-- ajuste a lista no bloco 0003 antes de rodar.
-- ============================================================================


-- ╔══════════════════════════════════════════════════════════════════════╗
-- ║ BLOCO 0001 — Setor / filial / localização                            ║
-- ╚══════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════╗
-- ║ BLOCO 0002 — Workflow de aprovação                                   ║
-- ╚══════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════╗
-- ║ BLOCO 0003 — Imagens de produto no painel (image_path + storage)     ║
-- ╚══════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════╗
-- ║ BLOCO 0004 — Views administrativas em português (schema admin)        ║
-- ╚══════════════════════════════════════════════════════════════════════╝
